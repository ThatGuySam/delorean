...
Building modern web applications shouldn't require weeks of configuration hell. Codename Delorean eliminates the tedious setup work so you can focus on what matters: shipping great products.
...
Codename Delorean is proudly supported by these amazing sponsors:
...
This project was bootstrapped with [Codename Delorean](https://github.com/kriasoft/react-starter-kit).
