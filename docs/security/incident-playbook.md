...
This playbook provides step-by-step procedures for handling security incidents in Codename Delorean projects. Each procedure includes specific actions, tools, and decision criteria.
...
We are investigating a security vulnerability in Codename Delorean.
...
```
Subject: [ACTION REQUIRED] Security Update for Codename Delorean
